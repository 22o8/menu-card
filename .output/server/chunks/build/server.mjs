...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-BdtkllOH.mjs')
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DejitmR5.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-cYxDvMDS.mjs'));

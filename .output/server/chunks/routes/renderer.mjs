...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Luxury restaurant QR menu with bilingual experience and interactive book-style menu."}],"link":[],"style":[],"script":[],"noscript":[],"title":"Luxury QR Menu"};
